        ...
        <div class="block text-center">
          ...
          <form class="text-left clearfix" id="submitSignUp" name="submitSignUp" action="submitSignUp.do" method="post">
            <div class="form-group">
              ...
              <button type="button" class="btn btn-main text-center" onclick="checkUniqueId();">중복 확인</button>
            ...
            <div class="form-group">
              <input type="email" name="email" id="email" class="form-control"  placeholder="이메일" onInput="resetWhenChangeEmail();">  
              <button type="button" class="btn btn-main text-center" onclick="checkUniqueEmail();">중복 확인</button>
...
<script type="text/javascript">
	...
	function resetWhenChangeId(){
		...
		idCheckText.innerHTML = "ID 중복확인이 필요합니다.";
	}
